...
//    document.writeln(`${multiDimensional[i].join(' ')} <br>`)
// }
...
//  document.writeln(`<h1> Multiplication table of ${table} <br> Length: ${length} </h1>`)
...
// //c
// var evenNumber = [];
// document.writeln(`<h1> Even Numbers </h1>`);
...
// var oddNumber = [];
// document.writeln(`<h1> Odd Numbers </h1>`);
